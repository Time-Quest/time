function initCanvas(){
    ...
    backgroundImage.src = "../Imagenes/trench.png"; //Background picture
    naveImage.src       = "../Imagenes/stukagr.png"; //Spaceship picture
    // Enemigos fotos
    enemiespic1.src     = "../Imagenes/p-47.png";
    enemiespic2.src     = "../Imagenes/p-51.png"; //Enemies picture
